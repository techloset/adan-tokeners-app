    ...
    <div className='bg-slate-950 text-white relative '>
      ...
      <div className="bg-cover h-auto w-auto bg-center " style={{ backgroundImage: `url(${Headergarient})` }}>
        ...
        <div className='grid lg:grid-cols-2 xl:grid-cols-2 grid-cols-1 '>
          <div className='lg:mt-[15rem] mt-[5rem] lg:ml-20 xl:mt-[15rem]  xl:ml-20 ml-5   '>
            ...
            <p className='text-zinc-400 mt-5 text-sm lg:w-[562px] xl:w-[562px] w-auto font-semibold'>We are creating social media 3.0 with influencers, celebrities and creators  being able to launch their
      ...
      <div className="pt-12 bg-cover bg-center flex flex-col lg:flex-row items-center justify-center mt-3 w-[100%] h-auto">
        <div className="lg:w-1/2  ">
          <img src={styleimg} alt='ImageStyle' className="w-[100%] h-auto lg:h-[70vh]  xl:h-[70vh]  rounded-tl-[50%] lg:rounded-tr-[50%] lg:rounded-tl-[0%]" />
        </div>
        <div className="lg:w-1/2 bg-white h-auto lg:h-[70vh]  xl:h-[70vh]  lg:rounded-tl-[50%] rounded-tr-[50%] lg:rounded-tr-[0%] flex flex-col justify-center items-center text-center p-6 overflow-hidden">
          <p className='text-5xl text-slate-900 font-semibold mt-24'>What makes us different?</p>
          <p className='text-md
           font-bold text-zinc-400 mt-3'>We would only launch tokens with the express permission of the creators.</p>
      ...
      <div className='lg:p-20 xl:p-20 md:p-10 p-5 relative'>
        <svg className="absolute top-0 right-0 hidden lg:block xl:block" xmlns="http://www.w3.org/2000/svg" width="278" height="287" viewBox="0 0 278 287" fill="none" >
      ...
      <div className='grid lg:grid-cols-2 xl:grid-cols-2 grid-cols-1 space-y-2 w-full mx-auto max-w-7xl px-5'>
        <Aboutus />
        <div className=''>
          <img
            src={phoneimg}
