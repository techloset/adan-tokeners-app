...
const BuyCard = () => {
    return (
        <>
            ...
            <div className="flex lg:flex-nowrap flex-wrap justify-center lg:justify-normal lg:mx-0 mx-5 gap-2">
                <div className="w-[511px] h-[270px] xs:w-[335px] xs:h-[216px] bg-[#171B29] rounded-[25px] relative mt-[50px] ">
                    ...
                    <div className="lg:h-[86px] lg:w-[86px] w-[60px] h-[60px] rounded-full bg-[#0F1320] flex justify-center items-center absolute lg:top-[43%] lg:left-[90%] left-[50%] top-[100%] -translate-x-2/4 -translate-y-2/4   lg:transform-none z-50">
                        <div>
                             <svg className="rotate-90 lg:rotate-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="w-[511px] h-[270px] xs:w-[335px] xs:h-[216px] bg-[#171B29] rounded-[25px] relative lg:ml-5 lg:mt-[110px] sm:mt-5 xs:mt-5">
                    ...
                    <div className="lg:h-[86px] lg:w-[86px]  w-[60px] h-[60px] rounded-full bg-[#0F1320] flex 
  justify-center items-center absolute lg:top-[20%] lg:left-[90%] left-[50%]   top-[100%] -translate-x-2/4 -translate-y-2/4  lg:transform-none z-50">
                        <div>
                            <svg  className="rotate-90 lg:rotate-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
