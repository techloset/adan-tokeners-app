        ...
        <div className=' xl:mx-[173px] sm:mx-10 lg:mt-0 sm:mt-20 xs:mt-20 justtify-center items-center'>
            ...
            <div className='flex lg:flex-nowrap sm:flex-wrap xs:flex-wrap sm:justify-center lg:justify-normal xs:mx-5'>
              <div className='w-[511px] h-[270px] xs:w-[335px] xs:h-[216px] bg-[#171B29] rounded-[25px] relative mt-[50px] '>
                ...
                <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px] xs:mt-5 xs:text-base'><p className='w-[52%] xs:w-[80%] opacity-80'>First Connect your Metamask or TrustWallet to the "Connect Wallet" on the Homepage.</p></div>
              ...
              <div className='w-[511px] h-[270px] xs:w-[335px] xs:h-[216px] bg-[#171B29] rounded-[25px] relative lg:ml-5 lg:mt-[110px] sm:mt-5 xs:mt-5'>
                ...
                <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px] xs:mt-5 xs:text-base'><p className='w-[50%] xs:w-[80%] opacity-80'>Then send minimum of 0.1 BNB or maximum of 10 BNB to the Presale wallet</p></div>
              ...
              <div className='w-[511px] h-[270px] xs:w-[335px] xs:h-[216px] bg-[#171B29] rounded-[25px] relative lg:ml-5 lg:mt-[50px] sm:mt-5 xs:mt-5'>
                ...
                <div className='flex flex-col justify-center items-center  text-lg font-bold leading-6 text-[#fff] mt-[45px] xs:mt-5 xs:text-base'><p className='w-[50%] xs:w-[80%] opacity-80'>Then after you will received your $WNTR to your address within 24hours. </p></div>
              </div>
            </div>
          </div>
