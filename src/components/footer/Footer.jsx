...
const Footer = () => {
  return (
    <div className='absolute bottom-0 w-full ' >
      ...
      <div className='lg:flex hidden flex-row justify-center items-center w-full gap-8'>
      ...
      <div className='w-full lg:justify-between flex lg:flex-row flex-col text-4xl lg:p-16 p-4 justify-center  items-center space-y-8 '>
        ...
        <div className=' block' >
          <p className='text-lg font-semibold text-white '>&copy; 2021 Tokners. All rights reserved.</p>
          <div className='flex items-center lg:justify-end justify-center'>
            ...
            <p className='underline text-sm text-slate-300'>Design by Oleg Kulik</p>
          </div>
        </div>
